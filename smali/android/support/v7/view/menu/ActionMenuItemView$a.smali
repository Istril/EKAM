...
# instance fields
.field final k:Landroid/support/v7/view/menu/ActionMenuItemView;
...
.method protected b()Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView$a;->k:Landroid/support/v7/view/menu/ActionMenuItemView;

    iget-object v2, v1, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/view/menu/h$b;

    const/4 v0, 0x0

    if-eqz v2, :cond_0

    iget-object v1, v1, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/k;

    invoke-interface {v2, v1}, Landroid/support/v7/view/menu/h$b;->a(Landroid/support/v7/view/menu/k;)Z
    ...
    invoke-interface {v1}, Landroid/support/v7/view/menu/t;->d()Z
