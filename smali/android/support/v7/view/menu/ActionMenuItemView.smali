...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, Lb/b/d/a/j;->ActionMenuItemView_android_minWidth:I
...
.method private f()V
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/k;
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->j:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->k:Z
...
.method public a(Landroid/support/v7/view/menu/k;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Landroid/support/v7/widget/h0;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/view/menu/h$b;

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/k;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_1
    invoke-virtual {p0, p1, v4, v4, v4}, Landroid/widget/TextView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
