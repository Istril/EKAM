...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, v1, p2, v0}, Landroid/widget/MultiAutoCompleteTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    invoke-virtual {p0}, Landroid/widget/MultiAutoCompleteTextView;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Landroid/support/v7/widget/p;->d:[I

    invoke-static {v1, p2, v2, v0, v3}, Landroid/support/v7/widget/y0;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/y0;

    move-result-object v1

    invoke-virtual {v1, v3}, Landroid/support/v7/widget/y0;->g(I)Z
    ...
    iput-object v1, p0, Landroid/support/v7/widget/p;->b:Landroid/support/v7/widget/e;

    iget-object v1, p0, Landroid/support/v7/widget/p;->b:Landroid/support/v7/widget/e;

    invoke-virtual {v1, p2, v0}, Landroid/support/v7/widget/e;->a(Landroid/util/AttributeSet;I)V

    invoke-static {p0}, Landroid/support/v7/widget/y;->a(Landroid/widget/TextView;)Landroid/support/v7/widget/y;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/y;

    iget-object v1, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/y;

    invoke-virtual {v1, p2, v0}, Landroid/support/v7/widget/y;->a(Landroid/util/AttributeSet;I)V
