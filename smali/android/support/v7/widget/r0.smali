...
.method a(Landroid/support/v7/app/a$c;Z)Landroid/support/v7/widget/r0$d;
    ...
    iget v3, p0, Landroid/support/v7/widget/r0;->i:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/r0;->c:Landroid/support/v7/widget/r0$c;

    if-nez v1, :cond_1

    new-instance v1, Landroid/support/v7/widget/r0$c;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/r0$c;-><init>(Landroid/support/v7/widget/r0;)V

    iput-object v1, p0, Landroid/support/v7/widget/r0;->c:Landroid/support/v7/widget/r0$c;
...
.method public a(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/r0;->b:Ljava/lang/Runnable;
    ...
    :cond_0
    new-instance v1, Landroid/support/v7/widget/r0$a;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/r0$a;-><init>(Landroid/support/v7/widget/r0;Landroid/view/View;)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0}, Lb/b/d/d/a;->e()I

    move-result v1

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/r0;->setContentHeight(I)V

    invoke-virtual {v0}, Lb/b/d/d/a;->d()I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/r0;->h:I
...
.method public onMeasure(II)V
    ...
    iput v3, p0, Landroid/support/v7/widget/r0;->g:I

    :goto_1
    iget v3, p0, Landroid/support/v7/widget/r0;->g:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/r0;->f:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/r0;->d:Landroid/support/v7/widget/i0;
    ...
    iget v0, p0, Landroid/support/v7/widget/r0;->j:I
    ...
    :cond_4
    iput v6, p0, Landroid/support/v7/widget/r0;->g:I
    ...
    :cond_6
    iget-object v1, p0, Landroid/support/v7/widget/r0;->e:Landroid/widget/Spinner;
    ...
    sget v5, Lb/b/d/a/a;->actionDropDownStyle:I

    invoke-direct {v1, v2, v4, v5}, Landroid/support/v7/widget/x;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v2, Landroid/support/v7/widget/i0$a;

    invoke-direct {v2, v8, v6}, Landroid/support/v7/widget/i0$a;-><init>(II)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/r0;->e:Landroid/widget/Spinner;

    :cond_7
    iget-object v1, p0, Landroid/support/v7/widget/r0;->d:Landroid/support/v7/widget/i0;

    invoke-virtual {p0, v1}, Landroid/widget/HorizontalScrollView;->removeView(Landroid/view/View;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/r0;->j:I
