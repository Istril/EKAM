...
.method private a()V
    ...
    sput-object v2, Landroid/support/v7/widget/c1;->k:Landroid/support/v7/widget/c1;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/c1;->h:Landroid/support/v7/widget/d1;
    ...
    invoke-static {v2}, Landroid/support/v7/widget/c1;->b(Landroid/support/v7/widget/c1;)V
...
.method private a(Z)V
    ...
    new-instance v0, Landroid/support/v7/widget/d1;

    iget-object v1, p0, Landroid/support/v7/widget/c1;->b:Landroid/view/View;

    invoke-virtual {v1}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/support/v7/widget/d1;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/c1;->h:Landroid/support/v7/widget/d1;

    iget-object v0, p0, Landroid/support/v7/widget/c1;->h:Landroid/support/v7/widget/d1;

    iget-object v1, p0, Landroid/support/v7/widget/c1;->b:Landroid/view/View;

    iget v2, p0, Landroid/support/v7/widget/c1;->f:I

    iget v3, p0, Landroid/support/v7/widget/c1;->g:I

    iget-boolean v4, p0, Landroid/support/v7/widget/c1;->i:Z

    iget-object v5, p0, Landroid/support/v7/widget/c1;->c:Ljava/lang/CharSequence;

    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/d1;->a(Landroid/view/View;IIZLjava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v7/widget/c1;->b:Landroid/view/View;

    invoke-virtual {v0, p0}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-boolean v0, p0, Landroid/support/v7/widget/c1;->i:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/c1;->e:Ljava/lang/Runnable;
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iput v0, p0, Landroid/support/v7/widget/c1;->g:I
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/widget/c1;->a(Z)V
