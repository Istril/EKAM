...
.field final d:Landroid/support/v4/media/MediaBrowserServiceCompat;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$h;->a:Ljava/util/List;
...
.method public a(Ljava/lang/String;ILandroid/os/Bundle;)Landroid/support/v4/media/m;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$h;->c:Landroid/os/Messenger;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$h;->c:Landroid/os/Messenger;

    invoke-virtual {v3}, Landroid/os/Messenger;->getBinder()Landroid/os/IBinder;

    move-result-object v3

    invoke-static {v2, v0, v3}, Landroid/support/v4/app/e;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat;->e:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {v2, v3, v0}, Landroid/support/v4/app/e;->a(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    :cond_0
    :goto_1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$h;->d:Landroid/support/v4/media/MediaBrowserServiceCompat;

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserServiceCompat;->a(Ljava/lang/String;ILandroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat$h;->a:Ljava/util/List;
...
.method public a()V
    ...
    invoke-direct {v0, v1, p0}, Landroid/support/v4/media/n;-><init>(Landroid/content/Context;Landroid/support/v4/media/p;)V
...
.method public a(Ljava/lang/String;Landroid/support/v4/media/o;)V
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v4/media/MediaBrowserServiceCompat;->a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$l;)V
